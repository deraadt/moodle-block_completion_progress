...
$string['resubmittednotcomplete_colour'] = '#FFCC00';
$string['resubmittednotcomplete_colour_descr'] = 'HTML colour code for elements that have been resubmitted, but are not yet complete';
$string['resubmittednotcomplete_colour_title'] = 'Resubmitted but not complete colour';
